    ...
    <div className="relative bg-white">
      ...
      <div className="relative pt-12 pb-16 px-4 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
        ...
        <div className="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
            ...
            At TC Coating, we believe in delivering more than just coating services. We strive to provide a professional, efficient and seamless experience that transforms your property while respecting your time and budget. We don't just coat your wall but we also restore it by repairing any cracks, damaged render and Flaky paint topped with our specialised textured paint ensuring a top quality finish!
            </p>
